...
\RequirePackage{color}\definecolor{RED}{rgb}{1,0,0}\definecolor{yellow}{rgb}{1,0.6,0} %DIF PREAMBLE
\RequirePackage[stable]{footmisc} %DIF PREAMBLE
\providecommand{\DIFadd}[1]{{\protect\color{yellow} \sf #1}} %DIF PREAMBLE
...
\DIFdelbegin \DIFdelend %DIF > Manufacturers provide datasheets with parameters that are normally used in the industry, but may not be useful or applicable for physics experiments.
...
\begin{thebibliography}{99}
	\bibitem{barnhill_testing_2008} Barnhill D, Suarez F, Arisaka K, \emph{et al}. Testing of photomultiplier tubes for use in the surface detector of the {Pierre} {Auger} observatory. Nucl\DIFdelbegin \DIFdelend \DIFaddbegin \DIFadd{. Instrum. Meth. }\DIFaddend A, 2008, {\bf 591}: 453--466.
	\href{http://dx.doi.org/10.1016/j.nima.2008.01.088}{DOI: 10.1016/j.nima.2008.01.088}
	\bibitem{akgun_complete_2005} Akgun U, Ayan A S, Bruecken P, \emph{et al}. Complete tests of 2000 {Hamamatsu} {R}7525HA phototubes for the {CMS}-{HF} {Forward} {Calorimeter}. Nucl\DIFdelbegin \DIFdelend \DIFaddbegin \DIFadd{. Instrum. Meth. }\DIFaddend A, 2005, {\bf 550}: 145--156.
	\href{http://dx.doi.org/10.1016/j.nima.2005.03.171}{DOI: 10.1016/j.nima.2005.03.171}
	\bibitem{adragna_pmt-block_2006} Adragna P, Antonaki A, Boudagov I, \emph{et al}. A {PMT}-{Block} test bench. Nucl\DIFdelbegin \DIFdelend \DIFaddbegin \DIFadd{. Instrum. Meth. }\DIFaddend A, 2006, {\bf 564}: 597--607.
	\href{http://dx.doi.org/10.1016/j.nima.2006.03.045}{DOI: 10.1016/j.nima.2006.03.045}
	\bibitem{Chang_Jin_dampe} Chang J\DIFdelbegin \DIFdelend \DIFaddbegin \DIFadd{, Dark matter particle explorer: the first chinese cosmic ray and hard }\DIFaddend $\gamma$-ray \DIFdelbegin \DIFdelend \DIFaddbegin \DIFadd{detector in space}\DIFaddend . Chinese Journal of Space Science, 2014, {\bf 34}: 550-556.
	\href{http://dx.doi.org/10.11728/cjss2014.05.550}{DOI: 10.11728/cjss2014.05.550}
	\bibitem{yuyuhong_led} Yu Y H, Xu H G, Zhan W L, \emph{et al}. Study of the LED based light calibration system for neutron wall detector. High Energ Phys\DIFdelbegin \DIFdelend \DIFaddbegin \DIFadd{. Nuc.}\DIFaddend , 2007, {\bf 31}: 581-585.
	\bibitem{sy1527lc} {CAEN S.p.A.}, Low \DIFdelbegin %DIFDELCMD < \href{http://www.caen.it/csite/CaenProd.jsp?idmod=491&parent=20}{http://www.caen.it/.}
%DIFDELCMD < 	%%%
\DIFdelend \DIFaddbegin \DIFadd{cost universal multichannel power supply system. }\href{http://www.caen.it/csite/CaenProd.jsp?idmod=491&parent=20}{http://www.caen.it}
	\DIFaddend \bibitem{cc_usb} {W-IE-NE-R Plein \& Baus GmbH.}\DIFaddbegin \DIFadd{, }\DIFaddend {CC-USB CAMAC \DIFdelbegin \DIFdelend \DIFaddbegin \DIFadd{controller }\DIFaddend with USB interface}. \DIFdelbegin %DIFDELCMD < \href{http://www.wiener-d.com/sc/modules/camac--modules/cc-usb.html}{http://www.wiener-d.com/.}
%DIFDELCMD < 	%%%
\DIFdelend \DIFaddbegin \href{http://www.wiener-d.com/sc/modules/camac--modules/cc-usb.html}{http://www.wiener-d.com}
	\DIFaddend \bibitem{leetro} {Leetro Automation Co. Ltd.}\DIFaddbegin \DIFadd{, }\DIFaddend {MPC07SP \DIFdelbegin \DIFdelend \DIFaddbegin \DIFadd{motion control board}\DIFaddend }. \DIFdelbegin %DIFDELCMD < \href{http://www.leetro.com/english/}{http://www.leetro.com/.}
%DIFDELCMD < 	%%%
\DIFdelend \DIFaddbegin \href{http://www.leetro.com/english/}{http://www.leetro.com}
	\DIFaddend \bibitem{integrating_sphere} {Mulansphere Co. Ltd.}\DIFaddbegin \DIFadd{, }\DIFaddend {Customized \DIFdelbegin \DIFdelend \DIFaddbegin \SI{5}{cm} \DIFadd{aluminum-alloy integrating sphere}\DIFaddend }. \DIFdelbegin %DIFDELCMD < \href{http://mulansphere.com/e-index.html/}{http://mulansphere.com/.}
%DIFDELCMD < 	%%%
\DIFdelend \DIFaddbegin \href{http://mulansphere.com/e-index.html/}{http://mulansphere.com}
	\DIFaddend \bibitem{afg3252} {Tektronix Company}\DIFdelbegin \DIFdelend \DIFaddbegin \DIFadd{, }\DIFaddend {AFG3000 \DIFdelbegin \DIFdelend \DIFaddbegin \DIFadd{series arbitrary}\DIFaddend /\DIFdelbegin \DIFdelend \DIFaddbegin \DIFadd{function generators quick start user manual}\DIFaddend }. \DIFdelbegin %DIFDELCMD < \href{http://www.tek.com/signal-generator/afg3000-function-generator/}{http://www.tek.com/.}
%DIFDELCMD < 	%%%
\DIFdelend \DIFaddbegin \href{http://www.tek.com/signal-generator/afg3000-function-generator/}{http://www.tek.com}
	\DIFaddend \bibitem{optical_fibre} Nanjing Chunhui Science and Technology Industrial Co. Ltd.\DIFdelbegin %DIFDELCMD < \href{http://www.china-light-guides.com/}{http://www.china-light-guides.com/.}
%DIFDELCMD < 	%%%
\DIFdelend \DIFaddbegin \DIFadd{, Customized plastic-clad silica fiber-bundle.  }\href{http://www.china-light-guides.com/}{http://www.china-light-guides.com}
	\DIFaddend \bibitem{pdcurses} PDCurses\DIFdelbegin \DIFdelend \DIFaddbegin \DIFadd{,  Public domain curses library }\DIFaddend for DOS, OS/2, Win32, X11 and SDL. \DIFdelbegin %DIFDELCMD < \href{http://pdcurses.sourceforge.net/}{http://pdcurses.sourceforge.net/.}
%DIFDELCMD < 	%%%
\DIFdelend \DIFaddbegin \href{http://pdcurses.sourceforge.net/}{http://pdcurses.sourceforge.net}
	\DIFaddend \bibitem{root} \DIFdelbegin %DIFDELCMD < \href{https://root.cern.ch/}{https://root.cern.ch/.}
%DIFDELCMD < 	%%%
\DIFdelend \DIFaddbegin \DIFadd{CERN,  ROOT data analysis framework. }\href{https://root.cern.ch/}{https://root.cern.ch}
	...
	\DIFaddend \bibitem{va160} Integrated Detector Electronics AS.\DIFaddbegin \DIFadd{, }\DIFaddend A 32-channel ASIC chip for PMT \DIFdelbegin %DIFDELCMD < \href{http://www.ideas.no/products/ide3160-2/}{http://www.ideas.no/.}
%DIFDELCMD < 	\bibitem{ni_visa} %%%
%DIFDELCMD < {%%%
%DIFDELCMD < } %%%
%DIFDELCMD < \href{http://www.ni.com/visa/}{http://www.ni.com/visa/.}
%DIFDELCMD < 	%%%
\DIFdelend \DIFaddbegin \DIFadd{spectrometer readout with trigger. }\href{http://www.ideas.no/products/ide3160-2/}{http://www.ideas.no}
	\DIFaddend \bibitem{yanghaibo_fee} Yang \DIFdelbegin \DIFdelend \DIFaddbegin \DIFadd{H B, Signals reading method and circuit design for multiple detection unit based on the advanced }\DIFaddend {ASIC} \DIFdelbegin \DIFdelend \DIFaddbegin \DIFadd{chips, }\DIFaddend Ph.D. Thesis, The University of Chinese Academy of Sciences, 2014.
	...
	\DIFaddend \bibitem{hamamatsu} Hamamatsu Photonics K. K., Photomultiplier tubes: basics and applications, 3rd \DIFdelbegin %DIFDELCMD < \href{http://www.hamamatsu.com/resources/pdf/etd/PMT_handbook_v3aE.pdf}{http://www.hamamatsu.com/resources/.}
%DIFDELCMD < %%%
