...
Testing of PMTs is a commonly encountered procedure in these applications.%%citing
These tests are citical for the following reasons:
\begin{itemize}
 \item Each project have specific requirements for the characteristics of PMTs.
 As PMTs exhibit big individual difference in their characteristics, these parameters should be tested thoroughly.
 Tubes that are not within the specification of the project will be rejected.
...
Massive testing of large number of PMTs cost much time and labor.
Usually, a dedicated test bench will be constructed to facilitate this work and improve efficiency.
Setting up a system of this kind is no trivial work.
It is desirable that the same test bench can be shared among different projects. 

For this purpose, a versatile test bench fot PMT fast characterization has been built up at the Institute of Modern Physics,CAS.
...
\section{Consideration in the design of the test bench}
