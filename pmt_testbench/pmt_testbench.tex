...
\begin{figure}[h!]
 \centering
 \includegraphics[width=80mm]{stage1_crop}
...
\begin{figure}
 \centering
 \includegraphics[width=80mm]{fibre_led_insphere_crop}
\caption{Components of the light distribution system}
\label{fig:fibre_led_sphere}
\end{figure} 

\begin{figure}
 \centering
 \includegraphics[width=80mm]{light_source1_crop}
...
\begin{figure}[h!]
 \centering
 \includegraphics[width=80mm]{uniformity_integratingsphere}
...
\begin{figure}[h!]
 \centering
 \includegraphics[width=80mm]{intesityVSvoltage}
...
\begin{figure}[h!]
 \centering
 \includegraphics[width=80mm]{correlation}
...
\begin{figure}[h!]
 \centering
 \includegraphics[width=80mm]{RelativeGainRef}
...
\begin{figure}[h!]
 \centering
 \includegraphics[width=80mm]{RelativeGainRefDist}
