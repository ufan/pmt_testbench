...
General purpose QDC of CAMAC or VME features a range of several hundreds \SI{}{\pico\coulomb} and thus not suitable for PMT characterization in this application.
Instead, the groud test DAQ of DAMPE are utilitized, which is based on the same design with the flight model except that commertial grade components are used.
