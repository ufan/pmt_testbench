...
The base is then coupled to the input port of integrating sphere directly,making the whole sphere as the LED's heat sink.
...
Integrating sphere is a perfect device for light uniformity.
However,the light pulse may be streched significantly due to multiple reflections in the sphere,making it unsuitable in time-related characterization.
