...
The PSD detector of the DAMPE project is a large-area plastic scintillator array. Based on the principle that the energy deposit in thin plastic scintillator is approximately proportional to $Z^2$, PSD aims for heavy ion charge measurement up to $Z=20$ as well as high energy e/$\gamma$ discrimination. It adopts the Hamamatsu R4443 PMT, which is a ruggedized version of the R647 tube, for the scintillation light detection. To cover the large dynamic range, two dynodes, 5 and 8, are readout for each R4443 tube, 
