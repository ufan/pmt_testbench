...
\author{%
      Yong Zhou (周勇)$^{1,2,3;1)}$%\email{yong@impcas.ac.cn}%
\quad Yu-Hong Yu (余玉洪)$^{1;2)}$%\email{yuyuhong@impcas.ac.cn}%
\quad Zhi-Yu Sun (孙志宇)$^{1;3)}$\email{sunzhy@impcas.ac.cn}
...
\begin{itemize}
	...
	For example, the photocathode scanning capability is desirable in cases that many scintillators are coupled to a single PMT~\citep{tof_pet}. 
